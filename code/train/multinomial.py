...
model_path = "models/claim_classifier_model.pkl"
...
val_report_path = "results/validation/multinomial_report.txt"
test_report_path = "results/test/multinomial_report.txt"
